...
const mergeDisplaySetAnimations = require('./svgo/mergeDisplaySetAnimations')
const mergeIdleTranslate = require('./svgo/mergeIdleTranslate')
...
class Game {
  ...
  generate() {
    ...
    const result = optimize(this.svg, {
      ...
      multipass: true,
      plugins: [
        mergeDisplaySetAnimations, // From 4.300 KB to 800 KB
        mergeIdleTranslate // From 800 KB to 400 KB
      ]
    });
    return result.data
  }
